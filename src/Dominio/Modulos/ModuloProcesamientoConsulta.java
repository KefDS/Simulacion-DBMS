...
public class ModuloProcesamientoConsulta extends Modulo {

    public ModuloProcesamientoConsulta(Simulacion simulacion, Modulo siguienteModulo, int numeroServidores) {
